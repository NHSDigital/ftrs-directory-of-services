resource "aws_route53_record" "read_only_viewer_record" {
  ...
  alias {
    name                   = module.read_only_viewer_cloudfront.cloudfront_distribution_domain_name
    zone_id                = module.read_only_viewer_cloudfront.cloudfront_distribution_hosted_zone_id
