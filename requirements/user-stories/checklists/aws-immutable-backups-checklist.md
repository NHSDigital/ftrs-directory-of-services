...
- Scope: essential service data backed; non‑data restore artifacts (config, production build, secrets, certificates) included; ≥2 immutable copies across window
...
- Upstream contribution: any new alerting/integration added to blueprint repo
