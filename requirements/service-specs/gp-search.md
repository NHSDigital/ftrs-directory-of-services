...
## 3. Actors & Use Cases
Primary actor: External clinical system / integration adapter calling the API to locate GP endpoints.
...
## 12. Traceability
All mapped NFR codes present in canonical registry `requirements/nfrs/cross-references/index.yaml` and linked via user stories STORY-176..STORY-185.
