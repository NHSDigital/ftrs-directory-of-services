...
summary: >-
  ...
  IAM, supplier obligations, PID handling and continuous penetration / dependency
...
- Add new codes (SEC-002..SEC-028) to `index.yaml` & cross-reference matrix.
- Derive acceptance criteria for stories referencing these codes.
- Implement linter to validate `nfr_refs`.
