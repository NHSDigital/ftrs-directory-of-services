...
| SCAL-005 | Automated scaling policies with defined triggers & guardrails (min/max, cooldown)         | Prevent oscillation & ensure predictability | Policy config lint + event simulation                        | scalability, automation, elasticity   |
