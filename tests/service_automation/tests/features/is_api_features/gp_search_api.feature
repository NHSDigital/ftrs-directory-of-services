...
Feature: API GP Endpoint Search
  ...
  Scenario: I search for GP Endpoint by ODS Code with valid query parameters
    When I request data from the "servicesearch" endpoint "Org" with query params "_revinclude=Endpoint:organization&identifier=odsOrganisationCode|M00081046"
  ...
  Scenario Outline: I search for GP Endpoint with invalid ODS code
    When I request data from the "servicesearch" endpoint "Org" with query params "<params>"
  ...
  Scenario: I search for GP Endpoint with 2 missing parameters
    When I request data from the "servicesearch" endpoint "Org" with query params ""
    Then I receive a status code "400" in response
    And the response body contains an "OperationOutcome" resource
