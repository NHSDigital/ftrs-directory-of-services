...
Feature: API GP Endpoint Search
  ...
  Scenario: I search for GP Endpoint by ODS Code with valid query parameters
    Given I request data from endpoint "organization" with query params "_revinclude=Endpoint:organization&identifier=odsOrganisationCode|M81046"
  ...
  Scenario Outline: I search for GP Endpoint with invalid parameters
    Given I request data from endpoint "organization" with query params "<params>"
