@data-migration @transactional-writes
Feature: Store migrated records in DynamoDB state table
  Test TransactWriteItems API for atomic insert/update operations and conflict detection
