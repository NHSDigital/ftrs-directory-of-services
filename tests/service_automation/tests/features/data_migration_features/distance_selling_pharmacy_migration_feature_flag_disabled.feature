@data-migration
Feature: Data Migration - Distance Selling Pharmacy with Feature Flag Disabled
  ...
  Scenario: Distance Selling Pharmacy migration when DATA_MIGRATION_PHARMACY_ENABLED is disabled
    Given the feature flag 'DATA_MIGRATION_PHARMACY_ENABLED' is set to 'false'
    Given a "Service" exists in DoS with attributes
      | key                                 | value                                                    |
      | id                                  | 10012350                                                 |
      | uid                                 | 999994                                                   |
      | name                                | Test Distance Pharmacy Flag Disabled                     |
      | odscode                             | FXX94                                                    |
      | openallhours                        | FALSE                                                    |
      ...
      | easting                             | 403453                                                   |
      | northing                            | 243634                                                   |
      | publicphone                         | 01234 567892                                             |
      | nonpublicphone                      | 09876 543212                                             |
      | fax                                 |                                                          |
      | email                               | flagtestdistance.pharmacy@nhs.net                        |
      | web                                 | www.flagtestdistancepharmacy.com                         |
      | createdby                           | HUMAN                                                    |
      ...
      | organisationid                      |                                                          |
      | returnifopenminutes                 |                                                          |
      | publicname                          | Test Distance Pharmacy Flag Disabled                     |
      | latitude                            | 52.0910543                                               |
      | longitude                           | -1.951003                                                |
    ...
    When the data migration process is run for table 'services', ID '10012350' and method 'insert'
