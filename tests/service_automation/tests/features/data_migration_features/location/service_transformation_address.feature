@data-migration
Feature: Service Migration - Address Transformation
  Scenario: Service with Address and County
  ...
  Scenario: Service with special characters in Address
    Given a 'Service' exists called 'TestGPPractice' in DoS with attributes:
      | key                 | value                                                               |
      | id                  | 900060                                                              |
      | uid                 | 200000                                                              |
      ...
      | restricttoreferrals | false                                                               |
      | postcode            | HA8 0AD                                                             |
      | address             | BISHOPS STORTFORD$83 South Street, Bishop's Stortford$Hertfordshire |
    ...
    And the service address for ID '900060' should be:
      ...
      | line1    | BISHOPS STORTFORD                   |
      | line2    | 83 South Street, Bishop's Stortford |
      | postcode | HA8 0AD                             |
      | town     | Bishop's Stortford                  |

  Scenario: Service with Address containing commas and extra newlines
    Given a 'Service' exists called 'TestGPPractice' in DoS with attributes:
      | key                 | value                                                                                   |
      | id                  | 900090                                                                                  |
      | uid                 | 200000                                                                                  |
  ...
  Scenario: Service without county
    Given a 'Service' exists called 'TestGPPractice' in DoS with attributes:
      | key                 | value                                                                                  |
      | id                  | 24165                                                                                  |
      | uid                 | 200023                                                                                 |
