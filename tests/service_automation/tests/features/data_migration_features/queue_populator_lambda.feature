...
Feature: Queue Populator Lambda - Single Service Support
  As a test author
  I want to verify the queue populator Lambda accepts single service events
  So that I can confirm individual services can be queued for migration without triggering full sync
