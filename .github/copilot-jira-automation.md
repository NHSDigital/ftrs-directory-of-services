...
5. If any registry (expectations YAML) was edited as part of the change, regenerate pages: `python3 scripts/nfr/refresh_simplified_nfr_page.py`.
...
Example Commit:
`feat(performance): Add dm-record-transform p95 baseline (STORY-PERF-001 FTRS-1612)`
