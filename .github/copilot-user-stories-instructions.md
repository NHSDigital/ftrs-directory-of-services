...
## 11a. Jira Ticket Association & Renaming

## 11a. Jira Story Automation Reference
Detailed workflow moved to `/.github/copilot-jira-automation.md`.
Summary:
- Add/update `jira_key:` (retain immutable `story_id`).
