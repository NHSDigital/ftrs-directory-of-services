...
# 1) 200 success - valid identifier with ODS code ABC123
do_call "/Organization?identifier=https://fhir.nhs.uk/Id/ods-organization-code%7CABC123" 200 "200 success (valid identifier)"
...
# 5) 404 not-found
do_call "/Organization?identifier=https://fhir.nhs.uk/Id/ods-organization-code%7CDEF456" 404 "404 not-found"

# 6) 500 internal-server-error
do_call "/Organization?identifier=https://fhir.nhs.uk/Id/ods-organization-code%7CGHI789" 500 "500 internal-server-error"
