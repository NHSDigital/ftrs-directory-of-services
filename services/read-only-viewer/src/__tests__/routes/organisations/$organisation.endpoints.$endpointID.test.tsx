...
describe("Organisation Endpoint Details", () => {
  ...
  it("should render the Endpoint Details page for an organisation", async () => {
    ...
    await act(() => router.navigate({
      ...
      params: { organisationID: "9521a4ee-d0e6-4cca-9d8c-123bfbf43123", endpointID: "db752ac7-d260-44c0-a36d-bd8939b3343e" }
    }));

    await waitFor(() => expect(app.getByText("Endpoint: db752ac7-d260-44c0-a36d-bd8939b3343e", { selector: "h1" })).toBeInTheDocument());
