...
from tools.opensearch_local_index_populator.temporary_sgsd_setup import (
    connect_to_dynamodb,
...
@patch("builtins.print")
@patch("tools.opensearch_local_index_populator.temporary_sgsd_setup.OpenSearch")
...
def test_connect_to_opensearch_parses_url_correctly():
    ...
    with patch(
        "tools.opensearch_local_index_populator.temporary_sgsd_setup.OpenSearch"
    ) as mock_os:
        mock_client = MagicMock()
...
@patch("builtins.print")
@patch(
    "tools.opensearch_local_index_populator.temporary_sgsd_setup.connect_to_dynamodb"
)
@patch(
    "tools.opensearch_local_index_populator.temporary_sgsd_setup.connect_to_opensearch"
)
@patch("tools.opensearch_local_index_populator.temporary_sgsd_setup.initialise_index")
@patch(
    "tools.opensearch_local_index_populator.temporary_sgsd_setup.scan_dynamodb_table"
)
@patch(
    "tools.opensearch_local_index_populator.temporary_sgsd_setup.convert_dynamodb_format"
)
def test_main(
