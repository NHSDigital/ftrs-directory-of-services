...
class EndpointMapper:
    ...
    @staticmethod
    def _create_address(endpoint: Endpoint) -> str:
        return endpoint.address

    @staticmethod
    def _create_managing_organization(endpoint: Endpoint) -> dict[str, str]:
    ...
    @staticmethod
    def _create_payload_type(endpoint: Endpoint) -> list[CodeableConcept]:
    ...
    @staticmethod
    def _create_payload_mime_type(endpoint: Endpoint) -> list[str]:
    ...
    @staticmethod
    def _create_order_extension(order: int) -> dict:
        return {
    ...
    @staticmethod
    def _create_compression_extension(is_compression_enabled: bool) -> dict:
        return {
    ...
    @staticmethod
    def _create_connection_type(endpoint: Endpoint) -> Coding | None:
