...
from src.common import error_util
from src.common.event_context import get_response_size_and_duration
from src.common.logbase import DosSearchLogBase
from src.common.middleware.request_context_middleware import request_context_middleware
from src.common.model.organization_headers import OrganizationHeaders
from src.common.model.organization_query_params import OrganizationQueryParams
...
def get_organization() -> Response:
    ...
    try:
        ...
        org_search_service = OrganizationSearchService()
        fhir_resource = org_search_service.endpoints_by_ods(ods_code)
