...
class TestODSClient:
    ...
    @patch("extractor.ods_client.build_common_headers")
    ...
    @patch("extractor.ods_client.build_common_headers")
    @patch("extractor.ods_client.is_ods_terminology_request")
    ...
    @patch("extractor.ods_client.is_mock_testing_mode")
    @patch("extractor.ods_client.is_ods_terminology_request")
    ...
    @patch("extractor.ods_client.SecretManager.get_mock_api_key_from_secrets")
    @patch("extractor.ods_client.is_mock_testing_mode")
    @patch("extractor.ods_client.is_ods_terminology_request")
    ...
    def test_make_request_integration(
        ...
        # Execute
        with patch("extractor.ods_client.build_common_headers", return_value={}):
            result = client.make_request(
