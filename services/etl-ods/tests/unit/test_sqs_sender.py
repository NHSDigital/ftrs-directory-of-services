...
def test_send_messages_to_queue_successful(
    ...
    with patch.dict(
        ...
        with patch("boto3.client") as mock_boto_client:
            ...
            with patch("common.sqs_sender.get_correlation_id", return_value="corr-123"):
...
def test_send_messages_to_queue_with_failed_messages(
    ...
    with patch.dict(
        ...
        mocker.patch("common.sqs_sender.get_correlation_id", return_value="corr-123")
...
def test_load_data_backward_compatibility(mocker: MockerFixture) -> None:
    ...
    mock_send = mocker.patch("common.sqs_sender.send_messages_to_queue")
...
#     ):
#         with patch("common.sqs_sender.get_correlation_id", return_value="test-correlation"):
#             with patch("boto3.client") as mock_boto_client:
#                 mock_sqs = MagicMock()
#                 mock_boto_client.return_value = mock_sqs
