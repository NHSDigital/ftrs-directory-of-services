...
from pipeline.utils.address_formatter import (
    _norm,
    format_address,
)
...
class TestAddressFormatter(unittest.TestCase):
    ...
    @patch("pipeline.utils.address_formatter.pycountry")
    ...
    def test_verify_county_detection_fallback_to_uk_counties(
        ...
        with patch("pipeline.utils.address_formatter.UK_COUNTIES", ["Hampshire"]):
