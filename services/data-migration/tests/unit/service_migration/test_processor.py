...
def test_process_service_contraception_parent_already_migrated(
    mocker: MockerFixture,
    mock_config: DataMigrationConfig,
    mock_logger: MockLogger,
    mock_legacy_service: Service,
    ...
    mocker.patch.object(
        ContraceptionPharmacyTransformer, "VALIDATOR_CLS", mock_validator_cls
    )
    mocker.patch.object(
        ContraceptionPharmacyTransformer,
        "transform",
...
def test_process_service_contraception_parent_needs_migration(
    mocker: MockerFixture,
    mock_config: DataMigrationConfig,
    mock_logger: MockLogger,
    mock_legacy_service: Service,
...
def test_process_service_contraception_parent_not_found(
    mocker: MockerFixture,
    mock_config: DataMigrationConfig,
    mock_logger: MockLogger,
    mock_legacy_service: Service,
