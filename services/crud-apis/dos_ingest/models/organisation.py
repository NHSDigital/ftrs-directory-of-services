...
class Organisation(BaseModel):
    ...
    name: str = Field(..., json_schema_extra={"example": "GP Practice Name"})
    ...
    telecom: list[Telecom] | None = Field(
        ...
        json_schema_extra={
            "example": [
                ...
                Telecom(
                    type=TelecomType.WEB, value="https://test.nhs.uk", isPublic=True
                ),
    ...
    type: str = Field(
        default="GP Practice", json_schema_extra={"example": "GP Practice"}
    )
...
class OrganisationUpdatePayload(BaseModel):
    ...
    resourceType: Literal["Organization"] = Field(
        ..., json_schema_extra={"example": "Organization"}
    )
    id: str = Field(
        ..., json_schema_extra={"example": "00000000-0000-0000-0000-00000000000a"}
    )
    # meta: dict = Field(
    #     ...,
    #     json_schema_extra={
    ...
    name: str = Field(max_length=100, json_schema_extra={"example": "GP Practice Name"})
    active: bool = Field(..., json_schema_extra={"example": True})
    telecom: list[ContactPoint] | None = Field(default_factory=list)
...
class OrganisationCreatePayload(Organisation):
    id: UUID | None = Field(
        None,
        json_schema_extra={"example": "d5a852ef-12c7-4014-b398-661716a63027"},
    )
    identifier_ODS_ODSCode: str = Field(
        max_length=12, min_length=1, json_schema_extra={"example": "ABC123"}
    )
