# FtRS NFR – Service: Ingress API – Domain: Governance
...
|--------|------|-------------|-------------|---------|
| Governance | [GOV-007](#IngressAPI–GovernanceNFRs&Controls-GOV-007) | FtRS Architects review & approval logged | Architecture review and approval logged by FtRS architects. | (none) |
| Governance | [GOV-008](#IngressAPI–GovernanceNFRs&Controls-GOV-008) | Cloud Expert deployment approval documented | Cloud expert deployment approval documented (infrastructure readiness). | (none) |
| Governance | [GOV-012](#IngressAPI–GovernanceNFRs&Controls-GOV-012) | TRG approval session outcome logged | Technical Review Group (TRG) approval outcome documented. | (none) |
...
| Control ID | Measure | Threshold | Cadence | Envs | Services | Status | Stories | Rationale |
|----------|-------|---------|-------|----|--------|------|-------|---------|
| trg-approval-outcome | TRG approval session outcome logged | Outcome recorded; decisions minuted; actions tracked | Pre-live | prod | Ingress API | draft | (none) | Documents technical governance approval |
