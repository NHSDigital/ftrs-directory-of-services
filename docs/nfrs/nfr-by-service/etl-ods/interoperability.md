...
|--------|------|-------------|-------------|---------|
| Interoperability | [INT-008](#ODSETL–InteroperabilityNFRs&Controls-INT-008) | Reference data sync latency ≤24h | Reference data synchronises within defined latency (e.g., ≤24h). | (none) |
