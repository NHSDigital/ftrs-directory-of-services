...
|--------|------|-------------|-------------|---------|
| Interoperability | [INT-001](../../explanations.md#Explanations-INT-001) | Resources validated against UK Core profiles | Resources conform to UK Core profiles ensuring national standard alignment. | (none) |
