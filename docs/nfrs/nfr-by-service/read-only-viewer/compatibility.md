...
|--------|------|-------------|-------------|---------|
| Compatibility | [COMP-001](#Read-onlyViewer–CompatibilityNFRs&Controls-COMP-001) | Published OS/browser list matches warranted spec | Supported OS/browser list matches published specification. | (none) |
| Compatibility | [COMP-002](#Read-onlyViewer–CompatibilityNFRs&Controls-COMP-002) | MFA (CIS2) succeeds across supported platforms | Multi-factor authentication (CIS2) works across supported platforms. | (none) |
| Compatibility | [COMP-003](#Read-onlyViewer–CompatibilityNFRs&Controls-COMP-003) | ≥90% critical journeys test pass per platform | Critical user journeys pass across all supported platforms at target success rate. | (none) |
