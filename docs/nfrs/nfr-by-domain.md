...
- Control: governance/verification check that enforces an NFR. Defines measure, threshold, tooling, cadence, environments/services scope, status, rationale, and stories for traceability.
